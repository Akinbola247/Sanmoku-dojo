  ...
  return (
    <div className='h-[300px] bg-[#FF3D00]'>
          <div className=' text-center w-[50%] mx-auto pt-5'>
                ...
                <p className='text-[#FFFFFF] mt-2 nova'>Lorem ipsum dolor sit amet consectetur. Penatibus a ut pretium cum varius aenean id. Molestie at aliquam sem integer non suspendisse amet ipsum. Scelerisque diam ipsum molestie mauris pulvinar gravida quisque nulla faucibus. Quis amet bibendum sed molestie.</p>
